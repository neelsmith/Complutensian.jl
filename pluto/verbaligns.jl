...
# ╔═╡ d16e7964-5d12-47c4-a789-b3fcd12a7be0
"""Select quadruplets of lemmata including the given lexeme as the value for the given language."""
function matchingquads(lang, lexeme, all_lemmata)
	if lang == "Hebrew"
		filter(all_lemmata) do tpl
			tpl.hlemma == lexeme
		end
	elseif lang == "Greek"
		filter(all_lemmata) do tpl
...
if isempty(vocabitem)
	...
	md"""So we're looking for $(vocabitem) in $(join(complist,", "))"""
end
...
matchingquads(baselang, vocabitem, lemmata)
